...
see how easy it became to transform the remaining tests into horizontal
tests. Rather than modify the test to fit the grid, is was much easier to
modify the grid to fit the already-working test, and thus reuse it.
*/
...
largestProductInGrid('01 02 01 02 05 01 01 03 01');
>[['02', '05', '03'], 30]

largestProductInGrid('01 02 01 02 05 01 01 03 01', 2);
>[['05', '03'], 15]

largestProductInGrid('01 02 01 02 05 01 01 03 01', 1);
>[['05'], 5]
