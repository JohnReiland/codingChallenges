const {sortArrayDesc, convertArrayToAbs, minAbsSum, maxBinary, binToInt, rangeArray, intToBin, binArray, generateS, bruteForce} = require('../Delta.2010');
...
describe('generateS()', () => {
  ...
  test('generateS([1, 2]) should be [[1, 1], [1, -1], [-1, 1], [-1, -1]]', () => {
    expect(generateS([1, 2])).toStrictEqual([[1, 1], [1, -1], [-1, 1], [-1, -1]]);
  })
...
describe('minAbsSum() vs. bruteForce()', () => {
  ...
  test('minAbsSum([8, 8, 8, 8, 8, 8, 14, 16, 18]) should equal bruteForce([8, 8, 8, 8, 8, 8, 14, 16, 18])', () => {
    expect(minAbsSum([8, 8, 8, 8, 8, 8, 14, 16, 18])).toBe(bruteForce([8, 8, 8, 8, 8, 8, 14, 16, 18]));
  })
  ...
  test('minAbsSum([21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 43, 47, 53, 59, 71]) should equal bruteForce([21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 43, 47, 53, 59, 71])', () => {
    expect(minAbsSum([21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 43, 47, 53, 59, 71])).toBe(bruteForce([21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 43, 47, 53, 59, 71]));
  })
